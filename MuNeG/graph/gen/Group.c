 ...
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Group", __pyx_methods, __pyx_k_Created_on_6_lut_2014_author_Ad, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  if (PyObject_SetAttrString(__pyx_m, "Group", (PyObject *)&__pyx_type_5graph_3gen_5Group_Group) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
